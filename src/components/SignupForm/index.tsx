...
const SignupForm = ({id}: LoginProps) => {
  ...
  const linkedInIcon = (
    <SvgIcon src="linkedin.svg" width="100%" height="100%" />
  );
      ...
      <FormGroup onSubmit={handleLoginFormSubmit}>
        ...
        <FormField>
          <MicrosoftLogin
            ...
            children={<Button startIcon={microsoftIcon} variant="outlined" style={{textTransform: 'none', width: '312px'}}>Sign up with Microsoft</Button>}
        ...
        <FormField>
          <Typography variant="body2" color="textSecondary">
            Already have an account? <Link href="/login" underline="none">Signin</Link>
          </Typography>
        </FormField>
        <FormField>
          <LoginFooter>
