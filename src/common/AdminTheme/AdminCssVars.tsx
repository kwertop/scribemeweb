...
const generateShadowVars = (theme: any) => {
  return theme.shadows.reduce(function (result: any, item: any, index: any, array: any) {
...
const AdminCssVars = ({ children }: Props) => {
  return <React.Fragment>{children}</React.Fragment>
}

export default withStyles(styles, { withTheme: true })(AdminCssVars);
